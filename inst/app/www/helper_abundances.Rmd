...
| Accession | Abundances_F1 | Abundances_F2 | Abundances_F3 |
|:----------|:--------------|:--------------|:--------------|
...
* Other columns: *Abundances_F#* – columns with protein abundances for each run
  (several runs may come from one patient – repetitions). Each column name must contain
